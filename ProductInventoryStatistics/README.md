# Day 15 — Product Inventory Statistics

## 🧠 Learning Note

### New Concept: Mapping Objects Before Aggregation
...
Employee → Group → Statistics
```

Today you'll practice:

```text
Object → Filter → Map Property → Aggregate
```
...
```text
Product → Compute Business Metrics
```
...
# 🚀 Day 15 — Inventory Value by Category
